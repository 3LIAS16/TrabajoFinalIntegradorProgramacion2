...
Ejecutar los siguientes script SQL en MySQL:

- Primero: Script de tablas.sql para generar las tablas
- Segundo: Script insert tabla configuracion.sql 
- Tercero: Script insert tabla dispositivoIoT.sql 
